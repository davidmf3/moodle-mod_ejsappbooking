...
class add_booking_external_controller{
      
    public function __construct($courseid){
        $this->model = new ejsappbooking_model(null, $courseid);
    }
    
    public function dispatch($exit){
    ...
    public function do($params){
        ...
        } else if ($this->model->booking_exists_external($labid,$practid,$sdate, $user_bk)) { // Check if the book exists.
        ...
        $data['bookid'] = $this->model->save_booking_external($labid, $practid, $starttime, $endtime, $user_bk);
